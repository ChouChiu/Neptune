...
<script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4.3.0/dist/index.global.js" integrity="sha384-uR+M0tuuV/GdNaUZNObkrySGXZcl1Kz3N6KZN5QnCh4=" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/lucide@1.17.0/dist/cjs/lucide.min.js" integrity="sha384-RaS3gBYcepsytHxuR+VBgSMEpvWnxbFqTzQraq2xs0w=" crossorigin="anonymous"></script>
<style>${styles}</style>
</head>
